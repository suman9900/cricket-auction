        ...
        {activePortal === 'auc_register' && (
          <div className="auth-portal-page animate-fade-in">
            ...
            {db.auctioneerRegistered ? (
              ...
              <div className="auth-card glass-panel flex-column" style={{ maxWidth: '460px', margin: '32px auto 0 auto', padding: '36px', borderRadius: '24px', border: '1px solid rgba(255,215,0,0.15)' }}>
                ...
                >
                  <div className="form-group text-left">
                    ...
                    <input type="text" className="input-premium" placeholder="e.g. Master Auctioneer" value={registerForm.auctioneerName} onChange={e => setRegisterForm({...registerForm, auctioneerName: e.target.value})} required autoFocus />
                  </div>
                  <div className="form-group text-left">
                    <label className="text-xs">Username / Admin ID</label>
